...
query.list <- subset(query.projected, subset = expansion %in% c("E",
    "NE"))
query.list <- SplitObject(query.projected, split.by = "expansion")
pll <- list()
...
DimPlot(query, group.by="functional.cluster", cols = refCols)
```
...
-   For more reading about the CD8+ T cell atlas construction, see the [human TIL atlas repository](https://github.com/carmonalab/human_TIL_atlas)
